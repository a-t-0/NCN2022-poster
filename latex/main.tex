...
\newcommand{\Contact}{e-mail: \mailto{akke.toeter@ru.nl}}
\newcommand{\Authors}{
	\hspace{-1ex}
    \begin{itemize*}[label=]
        %\item Custom text
...
\newcommand{\EventName}{NCN2022}
\newcommand{\EventLocation}{Nijmegen, Gelderland (The Netherlands)>}
...
\begin{rudiblockiintroduction}
    \begin{parcolumns}[colwidths={1=.5\linewidth}]{2}     
    %\begin{multicols}{2}
        \ifx\homepath\overleafhome
            % Overleaf compilation.
            \input{chapters/2_methodology.tex}
            %\vspace{4em}
            %\input{chapters/some_fig.tex}
        \else
            % Local compilation
            \input{latex/chapters/2_methodology.tex}
            %\vspace{4em}
            %\input{latex/chapters/some_fig.tex}
        \fi
    %\end{multicols}
    \end{parcolumns}
